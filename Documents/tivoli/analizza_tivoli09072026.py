...
PREV_DEF    = os.path.join(DOWNLOADS, "tivoli08072026_output", "buonipasto DEFINITIVO")  # 218 workers
OUT_ROOT    = os.path.join(DOWNLOADS, "tivoli09072026_output")
DEFINITIVO  = os.path.join(OUT_ROOT, "buonipasto DEFINITIVO")
OUT_ZIP     = os.path.join(DOWNLOADS, "tivoli09072026_DEFINITIVO.zip")
BUONO_EURO  = 4.13
BUONO_ORE   = 0.5
...
# ── Carry-forward dal DEFINITIVO 08/07 (218 worker) ──────────────────────────
print("Carry-forward da DEFINITIVO 08/07/2026...")
...
CRICCHI_ZIP = os.path.join(DOWNLOADS, "cricchialessandrativoli.zip")

# CRICCHI ALESSANDRA (Matricola 0000061038, A.06M LABORATORIO ANALISI TIVOLI)
# del tutto nuova: zip esterno con 2 zip annidati (Cartellini-2015-2024.zip + Cartellini-2025.zip),
# PDF singoli per mese/anno, garbage __MACOSX/._... filtrato in collect_pdfs_recursive
process_worker("CRICCHI ALESSANDRA",
               [(CRICCHI_ZIP, None)])
