...
android {
    namespace = "com.gianmarco.gym_app"
    ...
    signingConfigs {
        create("release") {
            storeFile = keystorePropertiesFile.exists().let { if (it) file(keystoreProperties["storeFile"] as String) else null }
    ...
    defaultConfig {
        applicationId = "com.gianmarco.gym_app"
