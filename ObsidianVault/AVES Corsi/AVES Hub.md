...
- **Corsi**: produzione, deploy automatico via GitHub Actions. Stato più recente noto in questa nota: **Task #76** (itemizzazione ore aggiornamento professionale istruttori, 329 record verificati) chiuso il 2026-06-23 — dettaglio [[Sessioni/2026-06-23]]. Sviluppi successivi fino al 07-06 non ancora riportati qui (vedi `_CLAUDE.md` → Ultime sessioni e commit recenti su `corsi`/`corsi-data`); da aggiornare alla prossima sessione sul progetto. Storico dettagliato pre-06-23 (s10-s19, tutti i task #40-#76): cronologia git di questa nota.
