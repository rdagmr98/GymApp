...
- **Corsi**: produzione, deploy automatico via GitHub Actions. Sessione 28 (2026-07-13): utente segnala 5 richieste in un messaggio. Filtro assenze "da recuperare" frequentatore mostrava tutte invece delle sole effettive, evidenza corsi multipli per istruttore in agenda, vincolo doppia prenotazione istruttore stessa ora (permesso solo se stessa lezione/task e somma frequentatori ≤28 teoria/≤15 pratica), ID task pratico mostrato nelle assenze — tutti risolti, commit `ac4210b`. Scoperta e risolta anche un'inflazione della currency (6h/anno sembravano troppe): root cause isolata in 79 voci di bulk-import "Ore insegnamento NBTC" (2026-06-06) che duplicavano ore già contate dalle lezioni a calendario — escluse ovunque in `GradeService.isBulkImportArtifact`, commit `4fad288`. Da `F-2-4 Programma settimanale Cat C.xlsx`: nuove ore M9/M10 da accreditare, Niespolo 28h (M10) e Signore 22h (M9), corso Cat.C MTOE-F-2-4 12/01–13/02/2026 — crediting bloccato da vincolo PII (richiede l'utente via admin→Currency→"Aggiorna ore"), in coda insieme al caso Minissi/Mirto di sessione 26. Dettaglio `corsi/CLAUDE.md` sessione 28. Sessione 26 (2026-07-06/07): OJT auto-decay + M9/M10 staccati, vedi [[Sessioni/2026-07-07]].
