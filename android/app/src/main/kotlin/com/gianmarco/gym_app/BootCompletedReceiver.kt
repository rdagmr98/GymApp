...
class BootCompletedReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val nextFireStr = prefs.getString("flutter.streak_reminder_next_fire", null) ?: return
        ...
        prefs.edit().putString("flutter.streak_reminder_next_fire", targetTime.toString()).apply()
    }
}
