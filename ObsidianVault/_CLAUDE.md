...
## Ultime sessioni
- [[Sessioni/2026-06-21]] — Corsi: chiusura di tutti i TODO pendenti residui (task #34-#38) — tab direttore "Storico lezioni" con filtri, root cause fix topic sottomoduli BTC2/BTC3 anche su editing nativo, voti basati su ultimo tentativo (non storico), data vera di recupero per le assenze (frequentatore+direttore), verificata visibilità ore da recuperare teoria/pratica (già completa da sessioni precedenti)
